<template>
  <div class="meta-container flex-wrap">
      <base-pdf-header applicationnumber="5427" formtitle="BUSINESS PERMIT AND LICENSING OFFICE" additionaltext="TAX YEAR ____" />
      <div class="meta-form-body">
          ...
          <div class="meta-text-group flex-wrap">
              ...
              <div class="meta-text w6 no-br">
                  <div class="meta-label">Are You enjoying tax incentive from any Government Entity ?</div>
          ...
          <div class="meta-text-group flex-wrap">
              <div class="meta-group-title">Name of President/Treasurer of Corporation : </div>
          ...
          <div class="meta-text-group flex-wrap">
              ...
              <div class="meta-text w4">
                  <div class="meta-label">No. of Employees residing in City/Municipality : </div>
          ...
          <!-- Lessor Details -->
          <div class="meta-text-group flex-wrap">
              <div class="meta-group-title">If Place of Business is Rented, please identify the following : </div>
              <div class="meta-text w6 no-br no-bb">
              ...
              <div class="meta-text no-bb">
                  ...
                  <div class="meta-value">Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum</div>
              </div>
              <div class="meta-text w6 no-br">
                  <div class="meta-label">Telephone No. & Mobile No. : </div>
                  <div class="meta-value">012-4526 / 09422136582</div>
          ...
          <div class="meta-text-group flex-wrap">
              ...
              <div class="meta-table-header flex-center">
                  ...
                  <div class="form-th sales">Gross Sales/Receipts (for Renewal)
